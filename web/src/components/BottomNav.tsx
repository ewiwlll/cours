    ...
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-zinc-950/95 backdrop-blur-xl border-t border-zinc-800/80 px-2 py-1.5 pb-safe select-none shadow-2xl">
      <div className="max-w-md mx-auto flex items-center justify-around relative">
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">Matières</span>
        </button>
        ...
        <div className="relative -top-3">
          <button
            ...
            title="Démarrer un enregistrement en amphi"
          >
            <div className="w-full h-full rounded-full bg-zinc-950 flex flex-col items-center justify-center gap-0.5 hover:bg-zinc-900 transition-colors">
              ...
              <span className="text-[8px] font-black uppercase tracking-wider text-red-300">Amphi</span>
            </div>
          </button>
        </div>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">Entraîner</span>
        ...
        >
          ...
          <span className="text-[10px] mt-0.5 tracking-tight">Planning</span>
        </button>
      </div>
    </nav>
  );
